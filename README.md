...
<head>
    ...
    <style>
        ...
        /* 999 PULSE (BG REMOVED VIA MIX-BLEND) */
        .juice-logo {
            width: 200px; height: auto;
            animation: pulse-logo 2s infinite;
            mix-blend-mode: screen; /* Removes black/white backgrounds */
        ...
        .gallery-item { width: 300px; height: 400px; flex-shrink: 0; border-radius: 1rem; border: 1px solid rgba(255, 255, 255, 0.1); overflow: hidden; cursor: pointer; }
...
<body class="min-h-screen">
    ...
    <div id="loading-screen">
        <div class="flex flex-col md:flex-row items-center justify-center gap-20 w-full px-10">
            <img src="st,small,507x507-pad,600x600,f8f8f8.u2.jpg" class="juice-logo" alt="999">
            ...
            <img src="drake-juicy-j-ovo-owl-11563499796p8md9xraom.png" class="ovo-logo" alt="OVO">
        </div>
    </div>
    ...
    <div id="main-wrapper">
        ...
        <main class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-4 pb-32">
            <div class="glass p-8 md:col-span-2 border-l-8 border-purple-600">
                ...
                <p class="text-2xl font-light italic leading-snug italic text-white/80">"Turning negativity into something positive. Late night melodies, palm trees, and the family that never sleeps."</p>
            </div>
            ...
            <div class="glass p-6 border-r-8 border-blue-600">
                ...
                <p class="font-mono text-[10px] uppercase">Tuesdays Active<br>Thursdays Variable<br>Weekend Collective</p>
            </div>
            ...
            <div class="glass p-6 border border-blue-500/20"><div class="flex items-center gap-4"><div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center font-bold">AM</div><div><p class="font-sync text-sm italic mb-1 text-balance">Aubrey D Graham</p><p class="text-[10px] font-mono opacity-60 uppercase">Co-Owner</p></div></div></div>
            <div class="glass p-8 md:col-span-2 grid grid-cols-3 gap-4 border-b border-white/5">
                <div class="text-center p-2"><p class="text-[9px] font-mono text-purple-400 uppercase">01 Hang</p><p class="text-[10px] font-sync uppercase italic">McDonald's</p></div>
                <div class="text-center p-2"><p class="text-[9px] font-mono text-blue-400 uppercase">02 Utility</p><p class="text-[10px] font-sync uppercase italic">Optimize Box</p></div>
                <div class="text-center p-2"><p class="text-[9px] font-mono text-red-400 uppercase">03 Rec</p><p class="text-[10px] font-sync uppercase italic">Among Us</p></div>
            </div>
        </main>
            ...
            const interval = setInterval(() => {
                if (width >= 100) {
                    ...
                    setTimeout(() => { 
                        ...
                        }, 2000); // 2 second delay before clearing screen
                    }, 1000);
                } else {
                    width += Math.random() * 4;
