...
<head>
    ...
    <style>
        ...
        /* FIX: SCHEDULE BOX - LONGER & SECURE */
        .schedule-box {
            min-width: 280px; 
            padding-left: 2rem;
            padding-right: 2rem;
        ...
        .location-card:hover { border-color: #bc13fe; transform: translateY(-5px); background: rgba(188, 19, 254, 0.05); }
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <main class="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-6 pb-48">
            ...
            <div class="glass border-r-4 border-purple-500 flex flex-col gap-3 schedule-box justify-center">
                <h3 class="font-sync text-[14px] mb-2 text-purple-400 uppercase font-bold italic tracking-[0.3em] text-center">Schedule</h3>
                <div id="day-tue" class="p-3 rounded font-mono text-[10px] uppercase border border-white/5 text-center">Every Tuesday</div>
                <div id="day-thu" class="p-3 rounded font-mono text-[10px] uppercase border border-white/5 text-center">Sometimes Thursday</div>
                <div id="day-wknd" class="p-3 rounded font-mono text-[10px] uppercase border border-white/5 text-center">Other Weekend</div>
            </div>
            ...
            <div class="glass p-8 flex items-center gap-5 border border-white/5">
                ...
                <div class="overflow-hidden">
                    <p class="font-sync text-sm italic leading-tight">Aubrey D Graham</p>
            ...
            <div class="glass p-8 md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="https://vrchat.com/home/world/wrld_1a8b8684-3b19-4770-a4a7-288762f57b29/info" target="_blank" class="location-card rounded-2xl">
                    <div class="flex flex-col items-center font-sync text-[11px] uppercase italic text-white tracking-widest">
                        <span>1's</span>
                        <span>Optimized</span>
                        <span>Box</span>
                    </div>
