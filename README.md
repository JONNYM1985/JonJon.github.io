...
<head>
    ...
    <style>
        ...
        .pulse-999 {
            ...
            color: #bc13fe; font-family: 'Syncopate'; font-weight: 900; font-size: 5rem;
            text-shadow: 0 0 30px #bc13fe;
        }

        .spin-owl {
            animation: spin-gold 4s linear infinite;
            font-size: 5rem; filter: drop-shadow(0 0 20px #fbbf24);
        }
...
<body class="min-h-screen">
    ...
    <div id="loading-screen">
        <div class="flex items-center justify-between w-full max-w-5xl px-20">
            ...
            <div class="flex flex-col items-center">
                ...
                <p id="load-text" class="mt-4 font-mono text-[10px] tracking-[1em] uppercase text-gray-500 italic">Decrypting...</p>
            </div>

            <div class="spin-owl">🦉</div>
        </div>
    </div>
    ...
    <main class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-4 pb-32">
        ...
        <div class="glass p-6 border border-blue-500/20"><div class="flex items-center gap-4"><div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center font-bold">AM</div><div><p class="font-sync text-sm italic mb-1">Aubrey D Graham</p><p class="text-[10px] font-mono opacity-60 uppercase">Co-Owner / Mikey</p></div></div></div>
        <div class="glass p-8 md:col-span-2 grid grid-cols-3 gap-4">
            <div class="text-center p-2 border border-white/5 rounded-lg"><p class="text-[9px] font-mono text-purple-400 uppercase">01 Hang</p><p class="text-[10px] font-sync uppercase italic">McDonald's</p></div>
            <div class="text-center p-2 border border-white/5 rounded-lg"><p class="text-[9px] font-mono text-blue-400 uppercase">02 Utility</p><p class="text-[10px] font-sync uppercase italic">Optimize Box</p></div>
            <div class="text-center p-2 border border-white/5 rounded-lg"><p class="text-[9px] font-mono text-red-400 uppercase">03 Rec</p><p class="text-[10px] font-sync uppercase italic">Among Us</p></div>
        </div>
        <div class="glass p-6 md:col-span-4 font-mono text-[10px] text-gray-500 h-24 overflow-hidden leading-relaxed uppercase border border-gray-900 italic">
            <p id="system-logs">> Decrypting 999 Database... > OVO Encryption Verified... > The Abyss is open.</p>
        </div>
    </main>
        ...
        function startLoading() {
            ...
            const interval = setInterval(() => {
                if (width >= 100) {
                    ...
                    setTimeout(() => { loadScreen.style.opacity = '0'; setTimeout(() => { loadScreen.style.display = 'none'; }, 500); }, 800);
                } else {
                    width += Math.random() * 5;
                    progress.style.width = width + '%';
                    if(width > 40) loadText.innerText = "AUTHENTICATING 999...";
                    if(width > 70) loadText.innerText = "OVO PROTOCOL SYNCING...";
                }
            }, 100);
        }
